...
def convertimgset(img_set="train"):
    imgdir = datasetprefix + "/WIDER_" + img_set + "/images"  # ./wider_face/WIDER_train/images
    gtfilepath = retinaface_gt_file_path + img_set + "/label.txt"  # ./retinaface_labels/train/label0u.txt
    imagesdir = rootdir + "/JPEGImages"   # ./wider_face_add_lm_10_10/JPEGImages
    vocannotationdir = rootdir + "/Annotations"  # ./wider_face_add_lm_10_10/Annotations
    labelsdir = rootdir + "/labels"  # ./wider_face_add_lm_10_10/labels
...
if __name__ == "__main__":
    convertdataset()
    shutil.move(rootdir + "/ImageSets/Main/" + "trainQ.txt", rootdir + "/ImageSets/Main/" + "trainvalQ.txt")
    shutil.move(rootdir + "/ImageSets/Main/" + "valQ.txt", rootdir + "/ImageSets/Main/" + "testQ.txt")
