...
def evaluation(pred, gt_path, iou_thresh=0.5):
    ...
    plt.title("Precision Recall Curve-R50s_289")
    plt.xlabel('Recall')
    ...
    plt.savefig("./PR/Precision_Recall_Curve-R50s_289.png")
    plt.show()


if __name__ == '__main__':
# /content/drive/MyDrive/Retinaface_Ghost-master/widerface_evaluate/wt/widerface_txtr1520_150
    parser = argparse.ArgumentParser()
    parser.add_argument('-p', '--pred', default="./wt/widerface_txtr50s_289/")
