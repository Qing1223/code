...
parser.add_argument('--dataset_folder', default='E:\\pycharm\\Retinaface_Ghost-master\\data\\widerface\\val\\images\\', type=str, help='dataset path')
...
if __name__ == '__main__':
    ...
    # data\widerface\val\label0u.txt
    print(testset_list)
